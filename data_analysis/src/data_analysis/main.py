...
if not os.path.exists(csv_path):
    ...
    print("Please ensure 'support_tickets_data.csv' is in the same directory as this script")
    exit(1)
...
def main():    
    ...
    final_report_assembly = Task(
        ...
        output_file='support_ticket_report.md'  # Save the final report as Markdown
    )
